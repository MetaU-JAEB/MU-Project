...
const { composeMongoose, composeWithMongooseDiscriminators } = require('graphql-compose-mongoose')
const { schemaComposer } = require('graphql-compose')

console.log('El dsicriminiatro', composeWithMongooseDiscriminators)
