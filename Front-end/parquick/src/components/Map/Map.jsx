...
function Map({ isLoaded }: Props): React.MixedElement {
  ...
  const center = useMemo(
    () => ({ lat: MAP_DEFAULT_LOCATION.LAT, lng: MAP_DEFAULT_LOCATION.LNG }),
    [],
  );
  ...
  useEffect(() => {
    ...
    setCircles(
      <>
        <Circle
          center={location}
          radius={MAP_CIRCLES_DISTANCES.CLOSE}
          options={mapsStyleOptions.closeOptions}
        />
        <Circle
          center={location}
          radius={MAP_CIRCLES_DISTANCES.MIDDLE}
          options={mapsStyleOptions.middleOptions}
        />
        <Circle
          center={location}
          radius={MAP_CIRCLES_DISTANCES.FAR}
          options={mapsStyleOptions.farOptions}
        />
      </>,
    );
  }, [location]);
