    ...
    return <>
        <div className='add-parking'>
            <form action="#">
                ...
                <input type="number" onChange={(e) => handleOnChangeParking(e, "totalLots")} className='add-parking-info' placeholder='Total amount of lots' />


                <fieldset>
                    <legend> Extras </legend>
                    <input type="checkbox" onClick={(e)=> handleOnClickBooleanParking(e, "hasShade")} name="has-shade" id="has-shade" />
                    <label htmlFor="has-shade" > Has shade </label>
                    <input type="checkbox" onClick={(e)=> handleOnClickBooleanParking(e, "isInInterior")} name="is-in-interior" id="is-in-interior" />
                    <label htmlFor="is-in-interior" > Is in interior </label>
                </fieldset>

                <fieldset>
                    <legend> Size </legend>
                    <input type="number" onChange={(e) => handleOnChangeParking(e, "height")} name="height" id="height" placeholder='height'/>
                    <input type="number" onChange={(e) => handleOnChangeParking(e, "length")} name="length" id="length" placeholder='length'/>
                    <input type="number" onChange={(e) => handleOnChangeParking(e, "width")} name="width" id="width" placeholder='width'/>
                </fieldset>

                <button type="submit" onClick={handleOnSubmitParking}> Add Parking</button>
